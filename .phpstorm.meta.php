    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'db.connector.firebird' => \Danidoble\Firebird\FirebirdConnector::class,
    ...
    override(\config(), map([
            ...
            'database.connections.firebird.driver' => 'string',
            'database.connections.firebird.dsn' => 'string',
            'database.connections.firebird.database' => 'string',
            'database.connections.firebird.username' => 'string',
            'database.connections.firebird.password' => 'string',
            'database.connections.firebird.charset' => 'string',
            'database.connections.firebird.collation' => 'string',
            'database.connections.firebird.prefix' => 'string',
            'database.connections.firebird.schema' => 'string',
            'database.connections.firebird.options' => 'array',
...
'database.connections.firebird.driver','database.connections.firebird.dsn','database.connections.firebird.database','database.connections.firebird.username','database.connections.firebird.password',
'database.connections.firebird.charset','database.connections.firebird.collation','database.connections.firebird.prefix','database.connections.firebird.schema','database.connections.firebird.options',
...
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','schedule-monitor.delete_log_items_older_than_days',
...
'schedule-monitor.oh_dear.endpoint_url','schedule-monitor.oh_dear.api_url','services.postmark.token','services.ses.key','services.ses.secret',
...
'settings.auto_discover_settings','settings.discovered_settings_cache_path','cors.paths','cors.allowed_methods','cors.allowed_origins',
...
'signed','throttle','verified','is_stock_admin','is_supplier',
'is_manager','is_driver','is_admin',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.clockwork','debugbar.assets.css','debugbar.assets.js','debugbar.cache.delete',
'debugbar.queries.explain','index','login','auth',
'logout','profile','manager','driver','stock_admin',
'stock_admin.supplier.ac','stock_admin.supplier','stock_admin.supplier.with_trashed','stock_admin.supplier.add','stock_admin.supplier.add_post',
'stock_admin.supplier.edit','stock_admin.supplier.edit_post','stock_admin.claim','stock_admin.claim.with_trashed','stock_admin.claim.add',
'stock_admin.claim.add_post','stock_admin.claim.edit','stock_admin.claim.edit_post','stock_admin.claim.slots','stock_admin.driver',
'stock_admin.driver.with_trashed','stock_admin.driver.one','stock_admin.driver.add','stock_admin.driver.add_post','stock_admin.driver.edit_post',
'stock_admin.driver.delete_post','stock_admin.driver.restore_post','stock_admin.driver.ac','stock_admin.expeditor','stock_admin.expeditor.with_trashed',
'stock_admin.expeditor.one','stock_admin.expeditor.add','stock_admin.expeditor.add_post','stock_admin.expeditor.edit_post','stock_admin.expeditor.delete_post',
'stock_admin.expeditor.restore_post','stock_admin.expeditor.ac','supplier','supplier.profile','supplier.claim',
'supplier.claim.with_trashed','supplier.claim.add','supplier.claim.add_post','supplier.claim.edit','supplier.claim.edit_post',
'supplier.claim.slots','supplier.driver','supplier.driver.with_trashed','supplier.driver.one','supplier.driver.add',
'supplier.driver.add_post','supplier.driver.edit_post','supplier.driver.delete_post','supplier.driver.restore_post','supplier.driver.ac',
'supplier.expeditor','supplier.expeditor.with_trashed','supplier.expeditor.one','supplier.expeditor.add','supplier.expeditor.add_post',
'supplier.expeditor.edit_post','supplier.expeditor.delete_post','supplier.expeditor.restore_post','supplier.expeditor.ac','supplier.car',
'supplier.car.add','supplier.car.add_post','admin','admin.user','admin.user.add_post',
'admin.user.delete_post','admin.user.edit_post','admin.user.one','admin.settings','admin.settings.add_post',
'admin.settings.delete_post','admin.settings.edit_post','admin.settings.one','admin.dictionary','admin.dictionary.car_type',
'admin.dictionary.car_type.add_post','admin.dictionary.car_type.delete_post','admin.dictionary.car_type.edit_post','admin.dictionary.car_type.one','admin.dictionary.gate',
'admin.dictionary.gate.add_post','admin.dictionary.gate.delete_post','admin.dictionary.gate.edit_post','admin.dictionary.gate.one','admin.dictionary.acceptance',
'admin.dictionary.acceptance.add_post','admin.dictionary.acceptance.delete_post','admin.dictionary.acceptance.edit_post','admin.dictionary.acceptance.one','storage.local',);
        registerArgumentsSet('views', 
'admin.dictionary.acceptance','admin.dictionary.car_types','admin.dictionary.gates','admin.dictionary.index','admin.index',
'admin.settings.index','admin.user.index','auth.login','layout.app','layout.auth_forms',
'manager.index','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'stock_admin.claim.add','stock_admin.claim.index','stock_admin.driver.add_form','stock_admin.driver.index','stock_admin.expeditor.add_form',
'stock_admin.expeditor.index','stock_admin.index','stock_admin.profile','stock_admin.supplier.add','stock_admin.supplier.index',
'supplier.claim.add','supplier.claim.index','supplier.driver.add_form','supplier.driver.index','supplier.expeditor.add_form',
'supplier.expeditor.index','supplier.index','supplier.profile','user.profile','vendor.pagination.bootstrap-4',
...
'pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','schedule-monitor::alert','schedule-monitor::components.duplicate-tasks',
...
'schedule-monitor::list','schedule-monitor::sync',);
...
'DB_PASSWORD','FIREBIRD_DSN','FIREBIRD_USERNAME','FIREBIRD_PASSWORD','FIREBIRD_DATABASE',
