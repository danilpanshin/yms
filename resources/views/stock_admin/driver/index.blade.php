                ...
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            @include('stock_admin.driver.add_form')
                        </div>
...
{{--                        <td>@foreach($row['roles'] as $role_row) <span class="badge rounded-pill bg-info">{{ $role_row['name'] }}</span> @endforeach</td>--}}
                        <td>
                            ...
                            @else
                                <a title="В архив" class="btn btn-sm btn-success ms-4" onclick="if(confirm('@php delete_confirm($row['name'], $row['id']) @endphp')){ $('.deleteForm').submit(); }">
