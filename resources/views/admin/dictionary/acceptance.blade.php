            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.dictionary.acceptance.add_post') }}" method="post" class="addForm">
                            @csrf
                            <div class="mb-3">
            ...
            @foreach($acceptances as $row)
                <tr>
                    ...
                    <td style="width: 160px;">
                        <form action="{{ route('admin.dictionary.acceptance.delete_post', $row['id']) }}" method="post" class="deleteForm">
                            @csrf
                        </form>
...
@section('script')
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('admin.dictionary.acceptance.edit_post') }}" id="editModal" method="post" class="editForm">
                        @csrf
    ...
    <script>
        $('.view_btn').on('click', function(){
            ...
            $.ajax({
                url: '{{ route('admin.dictionary.acceptance.one') }}/' + id,
